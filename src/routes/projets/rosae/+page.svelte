<div class="column" id="showcase">
    ...
    <div class="showcase" id="showcase_text">
        <h2 id="showcase_title">.\\ROSAE</h2>
       <div id="showcase_desc_wrapper">
        <p id="showcase_desc">Au fond du jardin, une drôle de rose pousse. Experimentation, manipulation photographique mêlant 2D et 3D. 
        </p>
         </div>
    </div>
</div>
