<details open id="about_details">
    ...
    <div class="about" id="about_contact">
      <a style="color:indianred;" href="/cv">cv<span style="opacity:0">ici !</span>  </a> <br><br>
      <a style="color:indianred;" href="mailto:g.gamichon@gmail.com">g.gamichon@gmail.com</a><br><br>
      <a style="color:indianred;"  href="https://twitter.com/Gamigre" target="_blank" rel="noopener noreferrer">twitter</a> <br><br>
