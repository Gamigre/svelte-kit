...
<div class="column" id="projects">
    <div class="projects" id="projects_container">
      ...
      <a id="p1" href="/projets/remanences">
        <div class="project_wrapper">
         <div class="projects_pic_container"  >
             <img class="projects_pic" src="/img/carreau_thumb.jpg" alt="Miniature représentant les carreaux de céramique du projet remanenc.es"> 
         </div>
         <span class="projects_pic_name" >Remanenc.es</span>
     </div></a>

     <a id="p2" href="/projets/bocalwaves">
      <div class="project_wrapper">
       <div class="projects_pic_container"  >
           <img class="projects_pic" src="/img/bocalwaves_thumb.jpg" alt="Miniature représentant un extrait généré avec le script du projet Bocalwaves"> 
       </div>
       <span class="projects_pic_name" >Bocalwaves</span>
   </div></a>

      <a id="p3" href="/projets/culturebox">
        <div class="project_wrapper">
        <div class="projects_pic_container"  >
            <img class="projects_pic" src="/img/culturebox_thumb.jpg" alt="Miniature représentant une frame du projet Culturebox"> 
        </div>
        <span class="projects_pic_name" >Culture Box</span>
    </div></a>

      <a id="p4" href="/projets/memoire">
        <div class="project_wrapper">
        <div class="projects_pic_container"  >
            <img class="projects_pic" src="/img/memoire_random_thumb.jpg" alt="Miniature représentant des pages du mémoire"> 
        </div>
        <span class="projects_pic_name" >Mémoire de DNSEP</span>
      </div></a>

      <a id="p5" href="/projets/volkswagen">
        <div class="project_wrapper">
        <div class="projects_pic_container"  >
            <img class="projects_pic" src="/img/vw_thumb.jpg" alt="Miniature représentant une frame des vidéos publicitaires du projet Volkswagen"> 
        </div>
        <span class="projects_pic_name" >VolksWagen</span>
      </div></a>
      ...
      <a id="p7" href="/projets/musee_dali">
        <div class="project_wrapper">
        <div class="projects_pic_container"  >
            <img class="projects_pic" src="/img/dali_thumb.jpg" alt="Miniature représentant une frame du projet pour le musée Dali"> 
        </div>
        <span class="projects_pic_name" >Musée Dali</span>
      </div></a>

      <a id="p8" href="/projets/confinement">
        <div class="project_wrapper">
        <div class="projects_pic_container"  >
            <img class="projects_pic" src="/img/confinement_thumb.jpg" alt="Miniature représentant une frame de mon film de fin d'études sur le confinement"> 
        </div>
        <span class="projects_pic_name" >À travers le confinement</span>
      </div></a>

      <a id="p9" href="/projets/ia_nation">
        <div class="project_wrapper">
        <div class="projects_pic_container"  >
      ...
      <a id="p10" href="/projets/obscure_process">
        <div class="project_wrapper">
        <div class="projects_pic_container"  >
            <img class="projects_pic" src="/img/obscureprocess_thumb.jpg" alt="Miniature représentant une page du fanzine Obscure Process"> 
        </div>
        <span class="projects_pic_name" >Obscure Process</span>
      </div></a>

      <a id="p11" href="/projets/make">
        <div class="project_wrapper">
        <div class="projects_pic_container"  >
            <img class="projects_pic" src="/img/kezakomake_thumb.jpg" alt="Miniature représentant une frame du projet de vidéo explicative pour make.org"> 
        </div>
        <span class="projects_pic_name" >Make.org</span>
      </div></a>

      <a id="p12" href="/projets/pif_gadget">
        <div class="project_wrapper">
        <div class="projects_pic_container"  >
            <img class="projects_pic" src="/img/pif_thumb.jpg" alt="Miniature représentant le logo de pif gadget"> 
        </div>
        <span class="projects_pic_name" >Pif Gadget</span>
      </div></a>

      <a id="p13" href="/projets/peer_captation">
        <div class="project_wrapper">
        <div class="projects_pic_container"  >
            <img class="projects_pic" src="/img/boeuf_thumb.jpg" alt="Miniature représentant une frame de la captation de la performance de Vjing peer captation"> 
        </div>
        <span class="projects_pic_name" >Peer Captation</span>
      </div></a>

      <a id="p14" href="/projets/fonte_obscur">
        <div class="project_wrapper">
        <div class="projects_pic_container"  >
            <img class="projects_pic" src="/img/obscur_thumb.jpg" alt="Miniature représentant une des lettres de la police libre Obscur"> 
        </div>
        <span class="projects_pic_name" >Fonte Obscur</span>
      </div></a>

      <a id="p15" href="/projets/rosae">
        <div class="project_wrapper">
        <div class="projects_pic_container"  >
            <img class="projects_pic" src="/img/rosae_thumb.jpg" alt="Miniature représentant une partie de l'oeuvre de glitch-art Rosae"> 
        </div>
        <span class="projects_pic_name" >._\\ROSAE</span>
      </div></a>
